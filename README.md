...
The output is 3 files in output dir. One , CSV file with each sample with it is predicted CST. Two, CSV file with CST composition. Three, barplot with relative abundace of CST.
